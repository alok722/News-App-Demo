...
public class CategoryTwo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView cat2_newsList = (RecyclerView)view.findViewById(R.id.cat2_recyclerView_layout);
        cat2_newsList.setLayoutManager(new LinearLayoutManager(getActivity()));
        ...
        cat2_newsList.setAdapter(new NewsListAdapter(enterStories_heading,enterStories_image,getContext()));
        cat2_newsList.addItemDecoration(new DividerItemDecoration(getActivity(), LinearLayoutManager.VERTICAL));
